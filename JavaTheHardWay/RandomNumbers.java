public class RandomNumbers {
	public static void main( String[] args ) {
		...
		int test1 = 1 + (int)(3 * Math.random());
		int test2 = 1 + (int)(3 * Math.random());
		int test3 = 1 + (int)(3 * Math.random());

		System.out.println(test1 + " " + test2 + " " + test3);

		int testy1 = 5 + (int)(6 * Math.random());
		int testy2 = 5 + (int)(6 * Math.random());
		int testy3 = 5 + (int)(6 * Math.random());

		System.out.println(testy1 + " " + testy2 + " " + testy3);
